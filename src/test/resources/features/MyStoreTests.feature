...
Scenario: Register to My Store web site
	...
	And   I enter email address "sel554@java.com" to register and click Create an account
...
Scenario: Login to My Store and add products to the cart
	...
	Given I launch the My Store application
	When  I click on sign in link
	And   I enter email address "sel554@java.com" and password "Pass123" and click signIn
